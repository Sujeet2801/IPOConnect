...
import { userLoginValidator, userRegistrationValidator } from '../validators/auth.validate.js';
...
router
    .route("/register")
    .post( userRegistrationValidator(), validate, registerUserController )
...
router
    .route("/login")
    .post( userLoginValidator(), validate, loginUserController )
