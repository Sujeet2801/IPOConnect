...
router
    .route("/ipo/update/:companyName")
    .put(isAuthenticated, authorizeRoles("ADMIN"), updateIpoController)

router
    .route("/ipo/:companyName")
    .delete(isAuthenticated, authorizeRoles("ADMIN"), deleteIpoController)

router
    .route("/ipos")
    .get(getAllIpoController)

router
    .route("/ipo/by-status")
    .get(getIposByStatusController)
